...
class LockFixTests(unittest.TestCase):
    ...
    def test_dashboard_cards_drag_resize_without_edit_button(self) -> None:
        ...
        self.assertIn('const dashboardPanelSizeKey = "lockfix.dashboard.panelSize.v4";', app_source)
        self.assertIn('data-dashboard-panel="backup" data-panel-resizable="true" data-cols="12" data-rows="5"', app_source)
        self.assertIn(".backup-panel {\n  min-height: 430px;", css_source)
        self.assertIn("20260529-veeam-jobs-visible", html_source)
