...
class LockFixTests(unittest.TestCase):
    ...
    def test_user_management_ui_has_i18n_actions_and_cache_bust(self) -> None:
        ...
        for token in [
            ...
            'v=20260519-dashboard-realtime-polish',
    ...
    def test_sidebar_user_menu_shows_current_session_without_navigation(self) -> None:
        ...
        self.assertIn("20260519-dashboard-realtime-polish", index_source)
    ...
    def test_airgap_live_reconnect_errors_are_visible_in_current_log(self) -> None:
        ...
        self.assertIn("20260519-dashboard-realtime-polish", html_source)
    ...
    def test_ops_events_description_is_hidden_until_show(self) -> None:
        ...
        self.assertIn("flex-wrap: wrap;", css_source)
        self.assertIn("order: 2;", css_source)
        self.assertIn("flex: 0 0 100%;", css_source)
        self.assertIn(".ops-events-hidden .ops-event-list", css_source)
        self.assertIn("grid-template-columns: max-content;", css_source)
    ...
    def test_dashboard_reload_deduplicates_slow_requests(self) -> None:
        ...
        self.assertIn('"generated_at": datetime.now().strftime("%Y-%m-%d %H:%M:%S")', webui_source)
    ...
    def test_dashboard_cards_drag_resize_without_edit_button(self) -> None:
        ...
        self.assertIn("font-weight: 400", css_source)
        self.assertIn("20260519-dashboard-realtime-polish", html_source)
        self.assertIn("grid-template-columns: repeat(5, minmax(88px, 104px));", css_source)
        ...
        self.assertIn("background: linear-gradient(90deg, #0d65df 0 50%, #17b85d 50% 100%);", css_source)
        self.assertIn("box-shadow: none;", css_source)
        self.assertNotIn("width: 66px;", css_source)
        self.assertNotIn("flex-basis: 66px;", css_source)
        self.assertNotIn('background: url("flow-backup-complete.png")', css_source)
        self.assertNotIn('background: url("flow-flush-run.png")', css_source)
        self.assertNotIn('background: url("flow-power-off.png")', css_source)
